...
// Which of the following statements are true regarding resource bundles in the
// context of localization? (Select ALL that apply.)
//
...
// c) Classes extending java.util.PropertyResourceBundle must override the
